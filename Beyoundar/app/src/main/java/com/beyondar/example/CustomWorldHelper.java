...
public class CustomWorldHelper {
	...
	public static World generateObjects(Context context) {
		...
		go1.setGeoPosition(-25.539356, -49.2828858);
		...
		go2.setGeoPosition(-25.534062, -49.267905);
		...
		go3.setGeoPosition(-25.519217, -49.291802);
		...
		go4.setGeoPosition(-25.540064, -49.282833);
		//go4.setImageUri("assets://creature_7.png");
		go4.setName("Creature 5");
		go4.setImageResource(R.drawable.creature_4);
		//go4.setName("Image from assets");


		GeoObject go5 = new GeoObject(5l);
		go5.setGeoPosition(-25.433484, -49.27433);
		go5.setImageResource(R.drawable.rectangle);
